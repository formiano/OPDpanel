...
SOFTCAM_SKIN = '<screen name="EmuManager" position="center,center" size="780,550" title="OPD Blue Panel">\n\t\t\t<widget name="choose_cam" position="10,10" size="185,30" font="Regular;22" />\n\t\t\t<widget name="config" position="10,100" size="400,100" transparent="1" />\n\t\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OPDpanel/icons/default_cam.png" position="70,60" size="800,60" transparent="1" alphatest="on"/>\n\t\t\t<widget name="ecminfo" position="180,215" size="400,290" font="Regular;18" />\n\t    \t\t<ePixmap pixmap="/usr/share/enigma2/oDreamy/menu/camcenter.png" zPosition="0" position="530,50" size="160,160" transparent="1" alphatest="on" />\n\t\t\t<ePixmap position="40,504" size="200,40" zPosition="0" pixmap="/usr/share/enigma2/oDreamy/buttons/redpanel.png" transparent="1" alphatest="on"/>\n\t\t\t<ePixmap position="200,504" size="200,40" zPosition="0" pixmap="/usr/share/enigma2/oDreamy/buttons/greenpanel.png" transparent="1" alphatest="on"/>\n\t\t\t<ePixmap position="360,504" size="200,40" zPosition="0" pixmap="/usr/share/enigma2/oDreamy/buttons/yellowpanel.png" transparent="1" alphatest="on"/>\n\t\t\t<ePixmap position="550,504" size="200,40" zPosition="0" pixmap="/usr/share/enigma2/oDreamy/buttons/bluepanel.png" transparent="1" alphatest="on"/>\n\t\t\t<widget name="key_red" position="70,504" zPosition="1" size="170,25" font="Regular;20" valign="top" halign="left" backgroundColor="red" transparent="1" />\n\t\t\t<widget name="key_green" position="230,504" zPosition="1" size="170,25" font="Regular;20" valign="top" halign="left" backgroundColor="green" transparent="1" />\n\t\t\t<widget name="key_yellow" position="390,504" zPosition="1" size="170,25" font="Regular;20" valign="top" halign="left" backgroundColor="yellow" transparent="1" />\n\t\t\t<widget name="key_blue" position="580,504" zPosition="1" size="170,25" font="Regular;20" valign="top" halign="left" backgroundColor="blue" transparent="1" />\n\t\t</screen>'
...
class ShowSoftcamPackages(Screen):
	...
	def setStatus(self,status = None):
		if status:
			...
			if status == 'update':
				statuspng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_PLUGIN, "Extensions/OPDpanel/icons/upgrade.png"))
			...
			if status == 'list':
				...
				statuspng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_PLUGIN, "Extensions/OPDpanel/icons/remove.png"))
	...
	def buildEntryComponent(self, name, version, description, state):
		...
		if not description:
			description = ""
		installedpng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_PLUGIN, "Extensions/OPDpanel/icons/installed.png"))
